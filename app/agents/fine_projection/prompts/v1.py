...
expected fine on the day you are summarizing, and the
...
- The current total expected fine and the mechanism that actually
  produced it.
- What is driving each violation type that currently has a non-zero
  expected fine (shortage, delay, or both), citing the real
