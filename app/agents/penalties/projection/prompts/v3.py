"""System prompt for penalty-projection-summary generation (v3)."""
...
delay_probability, each violation's expected_penalty); cite those values \
...
1. **Current status first.** Open with the total expected penalty as of \
