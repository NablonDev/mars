...
def list_batch_items(
    ...
    rows = job_queue_repository.list_run_items(job_run_id, status=status, limit=limit, offset=offset)
    ...
    return BatchItemListResponse(job_run_id=job_run_id, items=items, limit=limit, offset=offset)
