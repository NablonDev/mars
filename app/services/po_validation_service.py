...
class PoValidationService:
    ...
    def _run_po_line(self, batch_id: str, po_line_id: Any, po_line: PoLine) -> Dict[str, Any]:
        ...
        except Exception as exc:  # noqa: BLE001 - keep ingest batch moving per line
    ...
    @staticmethod
    def _thread_not_waiting(thread_id: str, expected: str, actual: Optional[str]) -> ServiceError:
        return ServiceError(
            "THREAD_NOT_WAITING",
