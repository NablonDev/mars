...
class MitigationEngine:
    """Stateless entry point for the fine-mitigation domain: ranks ACCEPT
    ...
    a new one per option; the fine rules and order snapshot themselves are
    ...
    def _speed_up_production_option(
        ...
        projected_fine_after = self._projection_engine.project(
