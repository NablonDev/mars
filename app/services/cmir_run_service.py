...
class CMIRRunService:
    ...
    def __init__(
        ...
        *,
        ...
        email_repository: Optional[PostgresEmailRepository] = None,
    ...
    def update_draft(
        ...
        *,
        ...
        field_changes = {
            field: {"from": existing_draft.get(field, ""), "to": value}
    ...
    def _update_graph_cmir(
        ...
        *,
        ...
        cmir_diff: Optional[Dict[str, Any]] = None,
        cmir_version_token: Optional[int] = None,
    ) -> CMIR:
