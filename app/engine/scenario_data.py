"""
Shared scenario definitions for the four worked examples, so the
validation script (run_examples.py) and the seed-data generator
(generate_seed_sql.py) read from a single source of truth instead of
two independently hand-typed copies.
"""

from datetime import date

from app.engine import AppointmentStatus, CalcType, FineRule, OrderSnapshot, ProductionStatus
