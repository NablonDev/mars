...
class CMIRRecordORM(Base):
    ...
    customer_identity: Mapped[str] = mapped_column(String(100))
    material_identity: Mapped[str] = mapped_column(String(100))
    intent_phrase: Mapped[str] = mapped_column(Text, nullable=True)
    ...
    customer_identity_key: Mapped[str] = mapped_column(String(100))
