...
class Agent(Base):
    ...
    source: Mapped[str] = mapped_column(String(20), default="fines")  # "fines" | "cmir"
...
class PromptVersion(Base):
    ...
    __tablename__ = "dim_prompt_version"
    __table_args__ = (
    ...
    id: Mapped[UUID] = mapped_column(UUID_PK, primary_key=True, default=generate_uuid7)
    agent_id: Mapped[UUID] = mapped_column(UUID_PK, ForeignKey(f"{FINES_SCHEMA}.dim_agent.id"))
    prompt_version: Mapped[str] = mapped_column(String(20))
    module_path: Mapped[str] = mapped_column(String(200))  # e.g. "app.agents.prompts.fine_summary.v2"
