...
class PoValidationWorkflowTests(unittest.TestCase):
    ...
    def test_touchless_path_when_quantity_sufficient(self) -> None:
        graph = self._build_graph(
            ...
            material_records={("MAT-1", "1000"): MaterialMasterRecord("MAT-1", "1000", available_quantity=500)},
        )
        state = graph.invoke(
            {"po_line_id": "line-1", "run_id": 1, "batch_id": "batch-1", "po_line": _po_line()},
    ...
    def test_qty_mismatch_offers_one_hop_substitute_and_proceed_anyway(self) -> None:
        ...
        state = graph.invoke(
            {"po_line_id": "line-2", "run_id": 1, "batch_id": "batch-1", "po_line": _po_line()},
    ...
    def test_qty_mismatch_mark_stale(self) -> None:
        ...
        graph.invoke(
            {"po_line_id": "line-3", "run_id": 1, "batch_id": "batch-1", "po_line": _po_line()},
    ...
    def test_use_substitute_that_is_still_short_re_triggers_mismatch(self) -> None:
        ...
        graph.invoke(
            {"po_line_id": "line-4", "run_id": 1, "batch_id": "batch-1", "po_line": _po_line()},
    ...
    def test_use_substitute_that_is_now_sufficient_completes(self) -> None:
        ...
        graph.invoke(
            {"po_line_id": "line-5", "run_id": 1, "batch_id": "batch-1", "po_line": _po_line()},
    ...
    def test_no_cmir_match_routes_to_manual_entry_then_loops_back(self) -> None:
        graph = self._build_graph(
            cmir_match=None,
            material_records={("MAT-100", "1000"): MaterialMasterRecord("MAT-100", "1000", available_quantity=500)},
        )
        state = graph.invoke(
            {"po_line_id": "line-6", "run_id": 1, "batch_id": "batch-1", "po_line": _po_line()},
    ...
    def test_lookup_failure_routes_to_handle_error_and_logs_one_po_line_error(self) -> None:
        ...
        state = graph.invoke(
            {"po_line_id": "line-7", "run_id": 1, "batch_id": "batch-1", "po_line": _po_line()},
