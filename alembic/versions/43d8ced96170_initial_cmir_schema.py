...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("follow_up_material_number", sa.String(length=50), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("customer_identity", sa.String(length=100), nullable=False),
        sa.Column("material_identity", sa.String(length=100), nullable=False),
        ...
        sa.Column("customer_identity_key", sa.String(length=100), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("thread_id", sa.String(length=50), nullable=True),
        sa.Column("email_id", sa.Uuid(), nullable=True),
        sa.Column("interrupt_type", sa.String(length=30), nullable=False),
        sa.Column(
            "question",
            sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), "postgresql"),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column("cmir_status", sa.String(length=30), nullable=True),
        sa.Column(
            "latest_snapshot",
            sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), "postgresql"),
            nullable=True,
